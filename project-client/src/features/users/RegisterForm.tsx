...
export default observer(function RegisterForm() {
    ...
    const [loginDetail, setLogin] = useState({ displayNAme: '', username: '', email: '', password: '' });
        ...
        <Container className="my-4">
            ...
            <Form noValidate validated={validated} onSubmit={handleSubmit}>
                ...
                <Form.Group className="mb-3" controlId="formDisplayName">
                    ...
                    <Form.Control required onChange={handleInputChange} name='displayName' type="text" placeholder="Enter Display Name" />
                </Form.Group>

                <Form.Group className="mb-3" controlId="formUsername">
                    <Form.Label>Username</Form.Label>
                    <Form.Control required onChange={handleInputChange} name='username' type="text" placeholder="Enter Username" />
                </Form.Group>
